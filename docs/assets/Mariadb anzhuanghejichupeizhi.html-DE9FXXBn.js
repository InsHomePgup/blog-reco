import{_ as a,r as e,o as i,c as t,a as n,e as l,b as o,d as r}from"./app-ClyKmoKW.js";const c={},d=n("p",null,"ARMBian安装",-1),p=n("p",null,"Debian 安装",-1),m={href:"https://mariadb.org/download/?t=repo-config&d=Debian+12+%22Bookworm%22&v=10.11&r_m=xtom_fre",target:"_blank",rel:"noopener noreferrer"},u=r(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
...
<span class="token function">sudo</span> <span class="token function">apt-get</span> <span class="token function">install</span> apt-transport-https <span class="token function">curl</span>
...
<span class="token function">sudo</span> <span class="token function">apt-get</span> <span class="token function">install</span> mariadb-server
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function v(b,k){const s=e("ExternalLinkIcon");return i(),t("div",null,[d,p,n("p",null,[n("a",m,[l("参考网站"),o(s)])]),u])}const g=a(c,[["render",v],["__file","Mariadb anzhuanghejichupeizhi.html.vue"]]),f=JSON.parse('{"path":"/blogs/Linux_Software/Mariadb/Mariadb anzhuanghejichupeizhi.html","title":"","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"开启远程访问","slug":"开启远程访问","link":"#开启远程访问","children":[{"level":3,"title":"开启配置中的远程连接","slug":"开启配置中的远程连接","link":"#开启配置中的远程连接","children":[]}]},{"level":2,"title":"创建一个用户来远程访问","slug":"创建一个用户来远程访问","link":"#创建一个用户来远程访问","children":[]}],"git":{"createdTime":1725768188000,"updatedTime":1725768188000,"contributors":[{"name":"abra","email":"7328234@gmail.com","commits":1}]},"filePathRelative":"blogs/Linux&Software/Mariadb/Mariadb 安装和基础配置.md"}');export{g as comp,f as data};
