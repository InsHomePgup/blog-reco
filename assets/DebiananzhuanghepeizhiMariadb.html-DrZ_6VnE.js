import{_ as a,c as e,a as n,b as i,d as l,e as p,o as t,r as c}from"./app-CgYSsB6L.js";const r={},o={href:"https://mariadb.org/download/?t=repo-config&d=Debian+12+%22Bookworm%22&v=10.11&r_m=xtom_fre",target:"_blank",rel:"noopener noreferrer"},d=p(`<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"></span>
...
<span class="line"></span>
<span class="line"><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> apt-transport-https <span class="token function">curl</span></span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 阿里云的源</span></span>
<span class="line"><span class="token comment"># MariaDB 10.11 repository list - created 2024-08-01 14:43 UTC</span></span>
<span class="line"><span class="token comment"># [https://mariadb.org/download/](https://mariadb.org/download/)</span></span>
<span class="line">X-Repolib-Name: MariaDB</span>
<span class="line">Types: deb</span>
<span class="line"><span class="token comment"># deb.mariadb.org is a dynamic mirror if your preferred mirror goes offline. See [https://mariadb.org/mirrorbits/](https://mariadb.org/mirrorbits/) for details.</span></span>
<span class="line"><span class="token comment"># URIs: [https://deb.mariadb.org/10.11/debian](https://deb.mariadb.org/10.11/debian)</span></span>
<span class="line">URIs: <span class="token punctuation">[</span>https://mirrors.aliyun.com/mariadb/repo/10.11/debian<span class="token punctuation">]</span><span class="token punctuation">(</span>https://mirrors.aliyun.com/mariadb/repo/10.11/debian<span class="token punctuation">)</span></span>
<span class="line">Suites: bookworm</span>
<span class="line">Components: main</span>
<span class="line">Signed-By: /etc/apt/keyrings/mariadb-keyring.pgp</span>
<span class="line"></span>
...
<span class="line"><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> mariadb-server</span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line">grant all privileges on *.* to gitea@<span class="token string">&quot;%&quot;</span> identified by <span class="token string">&quot;123&quot;</span> with grant option<span class="token punctuation">;</span> </span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line">grant all on gitea.* to &#39;gitea&#39;@&#39;%&#39;</span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function m(u,v){const s=c("ExternalLinkIcon");return t(),e("div",null,[n("p",null,[n("a",o,[i("参考网站"),l(s)])]),d])}const k=a(r,[["render",m],["__file","DebiananzhuanghepeizhiMariadb.html.vue"]]),h=JSON.parse('{"path":"/blogs/Linux_Software/Mariadb/DebiananzhuanghepeizhiMariadb.html","title":"Debian安装和配置Mariadb","lang":"en-US","frontmatter":{"title":"Debian安装和配置Mariadb","categories":["mariadb"],"tags":["mariadb"],"date":"2024/05/28"},"headers":[{"level":2,"title":"开启远程访问","slug":"开启远程访问","link":"#开启远程访问","children":[{"level":3,"title":"开启配置中的远程连接","slug":"开启配置中的远程连接","link":"#开启配置中的远程连接","children":[]}]},{"level":2,"title":"创建一个用户来远程访问","slug":"创建一个用户来远程访问","link":"#创建一个用户来远程访问","children":[]}],"git":{"createdTime":1718441261000,"updatedTime":1735111373000,"contributors":[{"name":"Abraham K.","email":"47906083+InsHomePgup@users.noreply.github.com","commits":1},{"name":"abra","email":"7328234@gmail.com","commits":1}]},"filePathRelative":"blogs/Linux&Software/Mariadb/Debian安装和配置Mariadb.md"}');export{k as comp,h as data};
