import{_ as n,o as s,c as a,e as t}from"./app-DqEpjd1R.js";const p={},e=t(`<h2 id="组件" tabindex="-1"><a class="header-anchor" href="#组件"><span>组件</span></a></h2><p>React 的组件 区分react组件和普通html元素的方式就是 react组件的首字母大写。</p><h3 id="创建组件" tabindex="-1"><a class="header-anchor" href="#创建组件"><span>创建组件</span></a></h3><blockquote><p>函数组件</p></blockquote><div class="language-tsx line-numbers-mode" data-ext="tsx" data-title="tsx"><pre class="language-tsx"><code>
