import{_ as n,c as s,o as a,e}from"./app-CB83U024.js";const l={},i=e(`<p>ES6 - ECMAScript 2015 的导入导出的一些方法。</p><h3 id="named-imports" tabindex="-1"><a class="header-anchor" href="#named-imports"><span>Named Imports</span></a></h3><p>具名的导入导出</p><p>这里是针对单个变量，或者函数的导入导出。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"></span>
