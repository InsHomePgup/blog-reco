import{_ as s,c as n,o as a,e}from"./app-CB83U024.js";const i={},l=e(`<h4 id="本地提交错分支的时候" tabindex="-1"><a class="header-anchor" href="#本地提交错分支的时候"><span>本地提交错分支的时候</span></a></h4><h5 id="有一个场景是有时候紧急fix但是提交到了错误分支。" tabindex="-1"><a class="header-anchor" href="#有一个场景是有时候紧急fix但是提交到了错误分支。"><span>有一个场景是有时候紧急fix但是提交到了错误分支。</span></a></h5><h6 id="使用reset-soft把内容退回到工作区。" tabindex="-1"><a class="header-anchor" href="#使用reset-soft把内容退回到工作区。"><span>使用reset soft把内容退回到工作区。</span></a></h6><p>方案一：</p><p>reset + stash reset 还原代码到工作区，stash暂存代码，切换到正确的分支以后再把stash代码回归到工作区。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"></span>
